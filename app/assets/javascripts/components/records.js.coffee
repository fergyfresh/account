      ...
      React.DOM.table
        ...
        React.DOM.tbody null,
          for record in @state.records
            React.createElement Record, key: record.id, record: record, handleDeleteRecord: @deleteRecord, handleEditRecord: @updateRecord, approveable: @props.current_user.supervisor && !record.approved, deleteable: @props.current_user.admin, isOwner: @props.current_user.id = record.user_id
