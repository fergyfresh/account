      ...
      React.DOM.table
        ...
        React.DOM.tbody null,
          for record in @state.records
            React.createElement Record, key: record.id, record: record, handleDeleteRecord: @deleteRecord, handleEditRecord: @updateRecord, approveable: @props.approveable, deleteable: @props.deleteable, isOwner: @props.isOwner
